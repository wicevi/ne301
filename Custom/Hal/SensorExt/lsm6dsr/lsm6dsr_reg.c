...
int32_t lsm6dsr_ln_pg_write_byte(const stmdev_ctx_t *ctx, uint16_t add,
                                 uint8_t *val)
{
  return lsm6dsr_ln_pg_write(ctx, add, val, 1);
}
                                   ...
                                   lsm6dsr_ois_on_t *val)
{
  ...
  switch (ctrl7_g.ois_on | (ctrl7_g.ois_on_en << 1))
  {
    ...
    case 3:
      *val = LSM6DSR_OIS_PRIMARY_INTERFACE_ON;
      break;

    case 1:
      *val = LSM6DSR_OIS_AUX_INTERFACE_ON;
      break;
                                  ...
                                  lsm6dsr_bdr_xl_t *val)
{
  ...
  switch (fifo_ctrl3.bdr_xl)
  {
    ...
    case 11:
      *val = LSM6DSR_XL_BATCHED_AT_1Hz6;
      break;
                                ...
                                lsm6dsr_shub_pu_en_t *val)
{
  ...
  {
    case 0:
      *val = LSM6DSR_INTERNAL_PULL_UP_OFF;
      break;

    case 1:
      *val = LSM6DSR_INTERNAL_PULL_UP_ON;
      break;
