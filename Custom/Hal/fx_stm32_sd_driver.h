...
extern osSemaphoreId_t sd_sem_tx;
extern osSemaphoreId_t sd_sem_rx;
/* Exported constants --------------------------------------------------------*/
/* USER CODE BEGIN EC */
...
#define FX_STM32_SD_CURRENT_TIME()                                   osKernelGetTickCount()
...
#define FX_STM32_SD_READ_CPLT_NOTIFY()                 do { \
                                                          if(osSemaphoreAcquire(sd_sem_rx, FX_STM32_SD_DEFAULT_TIMEOUT) != osOK) \
                                                            { \
                                                              return FX_IO_ERROR; \
                                                            } \
                                                        } while(0)
...
#define FX_STM32_SD_WRITE_CPLT_NOTIFY()                do { \
                                                          if(osSemaphoreAcquire(sd_sem_tx, FX_STM32_SD_DEFAULT_TIMEOUT) != osOK) \
                                                            { \
                                                              return FX_IO_ERROR; \
                                                            } \
                                                        } while(0)
