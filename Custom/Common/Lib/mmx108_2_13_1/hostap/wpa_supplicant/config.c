...
static char * wpa_config_write_p2p2_client_list(const struct parse_data *data,
						struct wpa_ssid *ssid)
{
	return wpa_config_write_list(data, ssid->p2p2_client_list);
}
...
static const struct parse_data ssid_fields[] = {
	...
	{ INT_RANGE(max_away_duration, 0, 65535)},
#ifdef CONFIG_MESH
...
#undef ecw2cw
	...
	config->autoscan_jitter = DEFAULT_ENABLE_AUTOSCAN_JITTER;
...
static const struct global_parse_data global_fields[] = {
	...
	{ INT(user_mpm), 0 },
#ifdef CONFIG_IEEE80211AH
	{ INT_RANGE(max_peer_links, 0, 20), 0 },
	...
	/* Large station support */
	{ INT_RANGE(autoscan_jitter, 0, 1), 0},
	{ INT_RANGE(scan_dwell, 0, 65535), 0},
