 ...
 *
 * Taken from:
 * https://github.com/gstrauss/hostap/blob/216d856f0a3e0702ec9134572a0ab5d3580a70e5/src/crypto/crypto_mbedtls.c
 *
 * Changes:
 *      - Removed aes-ctr implementations as the implementation provided by hostap is being used
 *      - Removed PKCS7 define and enforcement. This has compilation issues with our build flags.
 *        Caused `discarded-qualifiers`, `int-conversion`, and `incompatible-pointer-types`
 *        compilation errors. This is only needed for DOT1X DPP which is not currently supported.
 *
 *
