                                                       ...
                                                       uint32_t rx_buffer_count)
{
  ...
  workspace->tx_buffer_config =
    SLI_MALLOC(sizeof(sl_ethernet_tx_buffer_configuration_t) + tx_buffer_count * sizeof(sl_ethernet_tx_descriptor_t));
  ...
  workspace->rx_buffer_config =
    SLI_MALLOC(sizeof(sl_ethernet_rx_buffer_configuration_t) + rx_buffer_count * sizeof(sl_ethernet_rx_descriptor_t));
  ...
  workspace->thread_stack = SLI_MALLOC(ETHERNET_DRIVER_THREAD_STACK_SIZE);
