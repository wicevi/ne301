...
#include "FreeRTOS.h"
#include "task.h"
/* Forward declaration for pvTaskGetThreadLocalStoragePointer - ThreadX FreeRTOS compatibility may not provide it */
/* Provide forward declaration to ensure function is available */
void *pvTaskGetThreadLocalStoragePointer(void *xTaskToQuery, int xIndex);
#endif
