...
/* Per-instance parameters for YOLOv8 UF postprocess */
typedef struct {
...
{
    pp_od_yolo_v8_uf_params_t *pp_ctx = (pp_od_yolo_v8_uf_params_t *)hal_mem_alloc_any(sizeof(pp_od_yolo_v8_uf_params_t));
    if (!pp_ctx) {
        return AI_OD_POSTPROCESS_ERROR_NO;
    }
    memset(pp_ctx, 0, sizeof(pp_od_yolo_v8_uf_params_t));
...
{
    pp_od_yolo_v8_uf_params_t *pp = (pp_od_yolo_v8_uf_params_t *)pp_params;
    if (!pp) {
        return AI_OD_POSTPROCESS_ERROR_NO;
    }
...
static void od_pp_out_t_to_pp_result_t(od_pp_out_t *pObjDetOutput,
                                       pp_result_t *result,
                                       const pp_od_yolo_v8_uf_params_t *pp)
{
...
{
    pp_od_yolo_v8_uf_params_t *pp = (pp_od_yolo_v8_uf_params_t *)params;
...
const pp_entry_t pp_entry_od_yolo_v8_uf = {
    .name = "pp_od_yolo_v8_uf",
    .vt = &vt
};
